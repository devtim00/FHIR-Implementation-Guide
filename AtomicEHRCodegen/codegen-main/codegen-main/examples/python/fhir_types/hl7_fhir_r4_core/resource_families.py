...
DomainResourceFamily_resources = ['Observation', 'OperationOutcome', 'Patient']
...
ResourceFamily_resources = ['Bundle', 'DomainResource', 'Observation', 'OperationOutcome', 'Patient']
